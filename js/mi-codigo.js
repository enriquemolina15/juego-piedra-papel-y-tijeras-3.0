...
const cuandoSeHaceClick = function (evento) {
  ...
  puntos.innerHTML = "SCORE" + ":" + contadorPuntos;
...
var array = Object.keys(localStorage) //vemos todas las claves que hay, que coincide con los puntos obtenidos
  ...
  btnJugadas.addEventListener("click",function(){
    ...
    var numeroPartidas = document.querySelector("#numeroPartidas");
    numeroPartidas.innerText = "Numero de Jugadas" + ": " + numeroJugadas++;
    ...
    if (numeroJugadas>= 10) {
      ...
      var nombreIntroducido = prompt("escribe tu nombre"); // valor
